...
/// The possible sizes of the current device's screen
enum ScreenSizes {
  big,
  medium,
  small,
...
/// Returns the current device's screen size
ScreenSizes getScreenSize(BuildContext context) {
