...
class ForCustomersRoute extends StatelessWidget {
  static const routeName = '/forCustomers';

  /// The link to the Customer app on Google Play
  final appGooglePlayLink =
      'https://play.google.com/store/apps/details?id=com.distant_queue.customer';

  /// The link to the Customer app on the App Store
  final appAppStoreLink = 'https://apps.apple.com/app/id1523551412';
